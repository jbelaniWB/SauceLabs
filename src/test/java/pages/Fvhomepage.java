...
public class Fvhomepage {
	...
	String actualtitle;
	String strURL = "https://video.flixster.com";
	...
	public WebElement getElement(Fvhomepgelements webelement)
	{
		...
		case help:
			...
			break;
		case searchbtn:
			common=driver.findElement(By.xpath(".//*[@id='title-filters']/form/button"));
			break;
		case searchtextbox:
			common=driver.findElement(By.xpath(".//*[@id='title-filters']/form/span/input"));
			break;
		case filterdrpdown:
		...
		case searchresult:
			...
			break;
		case redeemcontinue:
			common=driver.findElement(By.cssSelector(".btn.btn-primary.btn-lg.btn-block.submit"));
			break;
		case enterredeemcode: 
			common=driver.findElement(By.cssSelector(".form-control.input-lg"));
			break;
